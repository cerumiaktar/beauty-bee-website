    ...
    return (
        <div className="mt-16">
            <div className="container mx-auto mb-16">
                <h1 className="text-2xl font-bold text-center mb-6 dark:text-black">Contact Us</h1>
                <div className="flex flex-col md:flex-row gap-6 border border-[#FFCFE6] rounded-2xl p-12">
                    <div className="md:w-6/12">
                        <div className="card-body">
                            <fieldset className="fieldset space-y-2">
                                <label className="label">Email</label>
                                <input type="email" className="input md:w-full" placeholder="Email" />
                                <label className="label">Password</label>
                                <input type="password" className="input md:w-full" placeholder="Password" />
                                <textarea className="textarea md:w-full" placeholder="Type a Message"></textarea>
                                <button className="btn bg-[#D42C7C] text-white mt-4">Submit</button>
                            </fieldset>
                        </div>
                    </div>
                    <div className="md:w-6/12">
